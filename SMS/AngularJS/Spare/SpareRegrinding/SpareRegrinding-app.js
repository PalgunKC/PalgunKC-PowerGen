var spareingregrindApp = angular.module('spareingregrindApp', ['datatables', 'commonApp', 'angularjs-dropdown-multiselect']);

spareingregrindApp.service('spareingregrindServices', function () {
...
spareingregrindApp.filter('unique', function () {
