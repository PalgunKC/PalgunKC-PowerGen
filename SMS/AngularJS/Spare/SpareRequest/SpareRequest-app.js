var SpareingrequestApp = angular.module('SpareingrequestApp', ['ui.bootstrap', 'commonApp', 'angularjs-dropdown-multiselect']);

SpareingrequestApp.service('SpareingrequestServices', function () {
    debugger;
    this.SpareingrequestData = function (SpareingRequestmaster) {
        this.SpareReq_id = SpareingRequestmaster ? SpareingRequestmaster.SpareReq_id : null;
        this.SpareReq_datetime = SpareingRequestmaster ? SpareingRequestmaster.SpareReq_datetime : null;
        this.SpareReq_shift = SpareingRequestmaster ? SpareingRequestmaster.SpareReq_shift : null;
        this.SpareReq_no = SpareingRequestmaster ? SpareingRequestmaster.SpareReq_no : null;
        this.SpareReq_plant = SpareingRequestmaster ? SpareingRequestmaster.SpareReq_plant : null;
        this.SpareReq_Partno = SpareingRequestmaster ? SpareingRequestmaster.SpareReq_Partno : null;
        this.SpareReq_Partname = SpareingRequestmaster ? SpareingRequestmaster.SpareReq_Partname : null;
        this.SpareReq_PartSpecification = SpareingRequestmaster ? SpareingRequestmaster.SpareReq_PartSpecification : null;
        this.SpareReq_uniquecode = SpareingRequestmaster ? SpareingRequestmaster.SpareReq_uniquecode : null;
        this.SpareReq_Linename = SpareingRequestmaster ? SpareingRequestmaster.SpareReq_Linename : null;
        this.SpareReq_Machinename = SpareingRequestmaster ? SpareingRequestmaster.SpareReq_Machinename : null;
        this.SpareReq_MachineCode = SpareingRequestmaster ? SpareingRequestmaster.SpareReq_MachineCode : null;
        this.SpareReq_TroubleReqno = SpareingRequestmaster ? SpareingRequestmaster.SpareReq_TroubleReqno : null;
        this.SpareReq_Employeeno = SpareingRequestmaster ? SpareingRequestmaster.SpareReq_Employeeno : null;
        this.SpareReq_Employeename = SpareingRequestmaster ? SpareingRequestmaster.SpareReq_Employeename : null;
        this.SpareReq_Qty = SpareingRequestmaster ? SpareingRequestmaster.SpareReq_Qty : null;
        this.SpareReq_AvailableQty = SpareingRequestmaster ? SpareingRequestmaster.SpareReq_AvailableQty : null;
        this.SpareReq_Reason = SpareingRequestmaster && SpareingRequestmaster.SpareReq_Reason ? SpareingRequestmaster.SpareReq_Reason : null;
        this.SpareReq_Remarks = SpareingRequestmaster ? SpareingRequestmaster.SpareReq_Remarks : null;
        this.IsActive = SpareingRequestmaster ? SpareingRequestmaster.IsActive : null;
        this.OrgID = SpareingRequestmaster ? SpareingRequestmaster.OrgID : null;
        this.CreatedBy = SpareingRequestmaster ? SpareingRequestmaster.CreatedBy : null;
        this.CreatedAt = SpareingRequestmaster ? SpareingRequestmaster.CreatedAt : null;
        this.ModifyBy = SpareingRequestmaster ? SpareingRequestmaster.ModifyBy : null;
        this.ModifyDate = SpareingRequestmaster ? SpareingRequestmaster.ModifyDate : null;
        this.Spare_Status = SpareingRequestmaster ? SpareingRequestmaster.Spare_Status : null;
        this.dummy_col2 = SpareingRequestmaster ? SpareingRequestmaster.dummy_col2 : null;
        this.KEY = SpareingRequestmaster ? SpareingRequestmaster.KEY : null;
        this.Sparetype = SpareingRequestmaster ? SpareingRequestmaster.Sparetype : null;

        this.Machinecode = SpareingRequestmaster && SpareingRequestmaster.Machinecode ? SpareingRequestmaster.Machinecode : [];
        this.LineMachine_Map_Id = SpareingRequestmaster ? SpareingRequestmaster.LineMachine_Map_Id : null;
        this.LineMachine_Line_Code = SpareingRequestmaster ? SpareingRequestmaster.LineMachine_Line_Code : null;
        this.LineMachine_Machine_Code = SpareingRequestmaster ? SpareingRequestmaster.LineMachine_Machine_Code : null;
        this.RegrainCode = SpareingRequestmaster ? SpareingRequestmaster.RegrainCode : null;
        this.PartId = SpareingRequestmaster ? SpareingRequestmaster.PartId : null;
        this.Requested_Emp_Number = SpareingRequestmaster ? SpareingRequestmaster.Requested_Emp_Number : null;
        this.Requested_Emp_Name = SpareingRequestmaster ? SpareingRequestmaster.Requested_Emp_Name : null;
        this.SpareIsu_Location = SpareingRequestmaster && SpareingRequestmaster.SpareIsu_Location ? SpareingRequestmaster.SpareIsu_Location : [];


    };

    this.SaveSpareingRequest = function (data) {
        debugger;
        this.url = "Spare/SaveSpareingRequest";
        this.param = JSON.stringify(data);
    };

    this.getLineDetails = function (data) {
        debugger;
        this.url = "Spare/GetLineDetails";
        this.param = JSON.stringify(data);
    };
});

SpareingrequestApp.filter('unique', function () {
