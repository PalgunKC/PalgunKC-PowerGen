SpareProductReportApp.controller('SpareProductReportCtrl', function (Excel, $timeout, $scope, $filter, SpareProductReportServices, commonService, DTOptionsBuilder, DTColumnBuilder, DTColumnDefBuilder) {
    ...
    // var chart = '';
     $scope.FetchProductReport = function (data) {
        ...
        $scope.jsonObj = [];
        $scope.CostjsonObj = [];
        var request = new SpareProductReportServices.FetchProductReport(data);
    ...
    $scope.GetQuantityReport = function (QuantityReport) {
        ...
        var request = new SpareProductReportServices.FetchProductReportExcel(QuantityReport);
        commonService.postWebService(request.url, request.param).then(function (response) {
            debugger;
