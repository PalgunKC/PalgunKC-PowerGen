var ToolingrequestApp = angular.module('ToolingrequestApp', ['ui.bootstrap', 'commonApp', 'angularjs-dropdown-multiselect']);

ToolingrequestApp.service('ToolingrequestServices', function () {
    debugger;
    this.ToolingrequestData = function (ToolingRequestmaster) {
        this.ToolReq_id = ToolingRequestmaster ? ToolingRequestmaster.ToolReq_id : null;
        this.ToolReq_datetime = ToolingRequestmaster ? ToolingRequestmaster.ToolReq_datetime : null;
        this.ToolReq_shift = ToolingRequestmaster ? ToolingRequestmaster.ToolReq_shift : null;
        this.ToolReq_no = ToolingRequestmaster ? ToolingRequestmaster.ToolReq_no : null;
        this.ToolReq_plant = ToolingRequestmaster ? ToolingRequestmaster.ToolReq_plant : null;
        this.ToolReq_Partno = ToolingRequestmaster ? ToolingRequestmaster.ToolReq_Partno : null;
        this.ToolReq_Partname = ToolingRequestmaster ? ToolingRequestmaster.ToolReq_Partname : null;
        this.ToolReq_PartSpecification = ToolingRequestmaster ? ToolingRequestmaster.ToolReq_PartSpecification : null;
        this.ToolReq_uniquecode = ToolingRequestmaster ? ToolingRequestmaster.ToolReq_uniquecode : null;
        this.ToolReq_Linename = ToolingRequestmaster ? ToolingRequestmaster.ToolReq_Linename : null;
        this.ToolReq_Machinename = ToolingRequestmaster ? ToolingRequestmaster.ToolReq_Machinename : null;
        this.ToolReq_MachineCode = ToolingRequestmaster ? ToolingRequestmaster.ToolReq_MachineCode : null;
        this.ToolReq_TroubleReqno = ToolingRequestmaster ? ToolingRequestmaster.ToolReq_TroubleReqno : null;
        this.ToolReq_Employeeno = ToolingRequestmaster ? ToolingRequestmaster.ToolReq_Employeeno : null;
        this.ToolReq_Employeename = ToolingRequestmaster ? ToolingRequestmaster.ToolReq_Employeename : null;
        this.ToolReq_Qty = ToolingRequestmaster ? ToolingRequestmaster.ToolReq_Qty : null;
        this.ToolReq_AvailableQty = ToolingRequestmaster ? ToolingRequestmaster.ToolReq_AvailableQty : null;
        this.ToolReq_Reason = ToolingRequestmaster && ToolingRequestmaster.ToolReq_Reason ? ToolingRequestmaster.ToolReq_Reason : null;
        this.ToolReq_Remarks = ToolingRequestmaster ? ToolingRequestmaster.ToolReq_Remarks : null;
        this.IsActive = ToolingRequestmaster ? ToolingRequestmaster.IsActive : null;
        this.OrgID = ToolingRequestmaster ? ToolingRequestmaster.OrgID : null;
        this.CreatedBy = ToolingRequestmaster ? ToolingRequestmaster.CreatedBy : null;
        this.CreatedAt = ToolingRequestmaster ? ToolingRequestmaster.CreatedAt : null;
        this.ModifyBy = ToolingRequestmaster ? ToolingRequestmaster.ModifyBy : null;
        this.ModifyDate = ToolingRequestmaster ? ToolingRequestmaster.ModifyDate : null;
        this.Tool_Status = ToolingRequestmaster ? ToolingRequestmaster.Tool_Status : null;
        this.dummy_col2 = ToolingRequestmaster ? ToolingRequestmaster.dummy_col2 : null;
        this.KEY = ToolingRequestmaster ? ToolingRequestmaster.KEY : null;
        this.Tooltype = ToolingRequestmaster ? ToolingRequestmaster.Tooltype : null;

        this.Machinecode = ToolingRequestmaster && ToolingRequestmaster.Machinecode ? ToolingRequestmaster.Machinecode : [];
        this.LineMachine_Map_Id = ToolingRequestmaster ? ToolingRequestmaster.LineMachine_Map_Id : null;
        this.LineMachine_Line_Code = ToolingRequestmaster ? ToolingRequestmaster.LineMachine_Line_Code : null;
        this.LineMachine_Machine_Code = ToolingRequestmaster ? ToolingRequestmaster.LineMachine_Machine_Code : null;
        this.RegrainCode = ToolingRequestmaster ? ToolingRequestmaster.RegrainCode : null;
        this.PartId = ToolingRequestmaster ? ToolingRequestmaster.PartId : null;
        this.Requested_Emp_Number = ToolingRequestmaster ? ToolingRequestmaster.Requested_Emp_Number : null;
        this.Requested_Emp_Name = ToolingRequestmaster ? ToolingRequestmaster.Requested_Emp_Name : null;
        this.ToolIsu_Location = ToolingRequestmaster && ToolingRequestmaster.ToolIsu_Location ? ToolingRequestmaster.ToolIsu_Location : [];
        this.ProductGroup = ToolingRequestmaster ? ToolingRequestmaster.ProductGroup : null;


    };

    this.SaveToolingRequest = function (data) {
        debugger;
        this.url = "Tool/SaveToolingRequest";
        this.param = JSON.stringify(data);
    };

    this.getLineDetails = function (data) {
        debugger;
        this.url = "Tool/GetLineDetails";
        this.param = JSON.stringify(data);
    };
});

ToolingrequestApp.filter('unique', function () {
