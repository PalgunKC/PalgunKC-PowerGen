var ToolingreturnApp = angular.module('ToolingreturnApp', ['datatables', 'commonApp', 'angularjs-dropdown-multiselect']);

ToolingreturnApp.service('ToolingreturnServices', function () {
    ...
    this.ToolingreturnData = function (ToolingReturnmaster) {
        ...
        this.Tooltype = ToolingReturnmaster ? ToolingReturnmaster.Tooltype : null;
        ...
        this.PartName = ToolingReturnmaster ? ToolingReturnmaster.PartName : null;
        this.PartSpecification = ToolingReturnmaster ? ToolingReturnmaster.PartSpecification : null;


        this.Is_Return = ToolingReturnmaster ? ToolingReturnmaster.Is_Return : null;
        ...
        this.RegrainCode = ToolingReturnmaster ? ToolingReturnmaster.RegrainCode : null;
        this.PartId = ToolingReturnmaster ? ToolingReturnmaster.PartId : null;
        this.Returned_Emp_Number = ToolingReturnmaster ? ToolingReturnmaster.Returned_Emp_Number : null;
        this.Returned_Emp_Name = ToolingReturnmaster ? ToolingReturnmaster.Returned_Emp_Name : null;
        this.ProductGroup = ToolingReturnmaster ? ToolingReturnmaster.ProductGroup : null;

    };

    this.SaveToolingReturn = function (data) {
        debugger;
...
ToolingreturnApp.filter('unique', function () {
