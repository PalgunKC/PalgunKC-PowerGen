var ToolingregrindApp = angular.module('ToolingregrindApp', ['datatables', 'commonApp', 'angularjs-dropdown-multiselect']);

ToolingregrindApp.service('ToolingregrindServices', function () {
...
ToolingregrindApp.filter('unique', function () {
