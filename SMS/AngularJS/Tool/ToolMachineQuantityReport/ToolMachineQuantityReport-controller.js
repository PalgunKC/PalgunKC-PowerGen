ToolMachineQuantityReportApp.controller('ToolMachineQuantityReportCtrl', function (Excel, $timeout, $scope, $filter, ToolMachineQuantityReportServices, commonService, DTOptionsBuilder, DTColumnBuilder, DTColumnDefBuilder) {
    ...
    // var chart = '';
     $scope.FetchToolMachineQuantity = function (data) {
         $scope.ReportType = data.Report_Type;
        // $scope.LineName = data.LineMachine_Line_Code;
        debugger;
        $scope.jsonObj = [];
        $scope.CostjsonObj = [];
        var request = new ToolMachineQuantityReportServices.FetchToolMachineQuantity(data);
        commonService.postWebService(request.url, request.param).then(function (response) {
            ...
            $scope.obj = new ToolMachineQuantityReportServices.ToolMachineQuantityReportData(data);
    ...
    $scope.GetQuantityReport = function (QuantityReport) {
        ...
        var request = new ToolMachineQuantityReportServices.FetchToolMachineQuantityExcel(QuantityReport);
        commonService.postWebService(request.url, request.param).then(function (response) {
            debugger;
